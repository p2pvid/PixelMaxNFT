...
function _BundleGraphRequest() {
  const data = _interopRequireDefault(require("./requests/BundleGraphRequest"));
...
class Parcel {
  ...
  async _build({
    ...
    try {
      ...
      let bundleGraph = await _classPrivateFieldGet(this, _requestTracker).runRequest(bundleGraphRequest); // $FlowFixMe Added in Flow 0.121.0 upgrade in #4381 (Windows only)
      ...
      let event = {
        ...
        bundleGraph: new (_BundleGraph().default)(bundleGraph, _Bundle().PackagedBundle.get, options),
