...
class MutableBundleGraph extends _BundleGraph().default {
  ...
  traverse(visit) {
    return _classPrivateFieldGet(this, _graph)._graph.filteredTraverse(nodeId => {
      let node = (0, _nullthrows().default)(_classPrivateFieldGet(this, _graph)._graph.getNode(nodeId));
